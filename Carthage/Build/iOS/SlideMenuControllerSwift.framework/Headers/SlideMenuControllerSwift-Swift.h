...
- (BOOL)isTagetViewController SWIFT_WARN_UNUSED_RESULT;
...
- (void)toggleLeft;
- (BOOL)isLeftOpen SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isLeftHidden SWIFT_WARN_UNUSED_RESULT;
- (void)toggleRight;
- (BOOL)isRightOpen SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isRightHidden SWIFT_WARN_UNUSED_RESULT;
...
- (SlideMenuController * _Nullable)slideMenuController SWIFT_WARN_UNUSED_RESULT;
